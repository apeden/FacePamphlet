...
public class FacePamphletProfile implements FacePamphletConstants {
	...
	/** 
	 * Constructor
	 * This method takes care of any initialisation needed for
	 * the profile.
	 */
	...
	public Iterator <String> getFriends() {
		// You fill this in.  Currently always returns null.
		Iterator<String> getFriendsIt = profileFriends.iterator();
		return getFriendsIt;
	}
	...
	public String toString() {
		...
		if (getFriendsIt.hasNext()) {
			readout  = readout + getFriendsIt.next();
